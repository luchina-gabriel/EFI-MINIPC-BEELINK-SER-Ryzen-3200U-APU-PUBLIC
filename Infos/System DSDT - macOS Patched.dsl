 ...
 *
 * Disassembly of iASLroaeIz.aml, Tue Oct  3 09:28:55 2023
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00008DB8 (36280)
 *     Revision         0x02
 *     Checksum         0x8A
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
        ...
        Device (RHUB)
        {
            ...
            Device (PRT3)
            {
                ...
                Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                {
                    If (ISDS)
                    {
                        Return (UPC2) /* \_SB_.PCI0.GP17.SHCI.RHUB.PRT3.UPC2 */
                    }
                    Else
                    {
                        Return (UPC1) /* \_SB_.PCI0.GP17.SHCI.RHUB.PRT3.UPC1 */
                    }
                }
